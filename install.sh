#!/usr/bin/env bash
# Instala o plasmoid "RSS Notícias" para o usuário atual (Plasma 6).
set -euo pipefail

cd "$(dirname "$0")"
PACKAGE_DIR="plasmoid"
NAME="rafael.rssnoticias"
...
echo "  • Botão direito no desktop → “Adicionar Widgets” → procure por “RSS Notícias”."
